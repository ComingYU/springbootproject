        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/project?serverTimezone=GMT%2b8", "root", "231006")
                .globalConfig(builder -> {
                    builder.author("ComingYU") // 设置作者
                            ...
                            .outputDir("D:\\code\\vue_springboot\\springboot\\sre\\main\\java\\"); // 指定输出目录
                })
                ...
                .packageConfig(builder -> {
                    builder.parent("com.project.springboot") // 设置父包名
                            .moduleName("") // 设置父包模块名
                            .pathInfo(Collections.singletonMap(OutputFile.xml, "D:\\code\\vue_springboot\\springboot\\src\\main\\resources\\mapper\\User.xml\\")); // 设置mapperXml生成路径
                })
